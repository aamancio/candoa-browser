                ...
                SettingsCard {
                    SettingsRow(
                        ...
                        subtitle: defaultBrowserService.isDefaultBrowser
                            ? String(localized: "Talos is the default browser in macOS.")
                            : String(localized: "Set Talos as the default browser in macOS.")
                    ) {
                    ...
                    SettingsToggleRow(
                        ...
                        title: String(localized: "Always check if Talos is your default browser"),
                    ...
                    SettingsPickerRow(
                        ...
                        options: [
                            ...
                            SettingsPickerOption(
                                ...
                                title: String(localized: "When quitting Talos")
                            ),
                            SettingsPickerOption(
...
internal struct AdvancedSettingsPane: View {
    @AppStorage("TalosEnableWebInspector") private var isWebInspectorEnabled = false
