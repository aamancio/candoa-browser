    ...
    var body: some Commands {
        ...
        CommandGroup(replacing: .sidebar) {
            ...
            Group {
                ...
                // sidebars — Reader, then Downloads — with Talos's own
        ...
        // Tab and Duplicate Tab. Spaces are Talos's tab groups, so they take
        ...
        // Spaces are what Talos is organized around, so they get the menu
        ...
        // Safari's Develop menu order, keeping Talos's own items: opening
        ...
        CommandMenu("Develop") {
            ...
            Group {
                ...
                // Safari's local-device targets, scoped to Talos's own
                ...
                Menu {
                    if let pages = actions?.inspectablePages, !pages.isEmpty {
                        Button(action: {}) { Text(verbatim: "Talos") }
                            .disabled(true)
                ...
                // Talos's per-site Developer Mode deliberately has no row
            ...
            Group {
                ...
                // Safari's Shift-Command-C belongs to Talos's Copy URL, so
