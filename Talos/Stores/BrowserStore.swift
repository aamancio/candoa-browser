...
final class BrowserStore: ObservableObject {
    ...
    static let onboardingStepKey = "Talos.InitialOnboarding.Step"
    static let hasCompletedOnboardingKey = "Talos.InitialOnboarding.Completed"
    static let hasCompletedTourKey = "Talos.InitialOnboarding.TourCompleted"
