# Luma Battery Benchmark

Reproducible methodology for comparing Luma's energy use against Arc, Brave,
...
- **System WebKit.** Luma rides the same engine processes as Safari — Apple's
...
7. For the hibernation story, run a second Luma pass after the tabs have been
   idle 20+ minutes (`luma-hibernated`) — that's the headline delta.
...
> Luma (my WebKit browser) vs Arc vs Brave vs Zen — identical 12 tabs,
